...
public class changeCustomerCSV {
        public static void load_into_customer_csv(String FirstName,String LastName,String PhNo,String EmailID,String LoginId,String Password, String Dob,String CustID,String memst) throws IOException
        {
